                    ...
                    var addListeners = function addListeners() {
                        ...
                        this.addListener('drag', 'node', function () {
                            ...
                            if (_this.dropTarget.nonempty()) {
                                ...
                                // run only when the grabbedNode'type is "control" or "asset"
                                if (/*_this.grabbedNode.data("nodeType") == "control" || */_this.grabbedNode.data("nodeType") == "asset") {
                                    // not in a parent
                                    ...
                                    if (overlappingNodes.length > 0) {
                                        // Update Plugin - Add condition
                                        // run only when the type of the targetNode matches with the type of the grabbedNode
                                        if (
                                            //(overlappingNodes[0].data("nodeType") == "control" && _this.grabbedNode.data("nodeType") == "control") ||
                                            (overlappingNodes[0].data("nodeType") == "asset" && _this.grabbedNode.data("nodeType") == "asset") ||
                                            (overlappingNodes[0].data("nodeType") == "asset-group" && _this.grabbedNode.data("nodeType") == "asset-group")
                                        ) {
