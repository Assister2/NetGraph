(function () {
    ...
    var LabelElement = (function () {
        ...
        LabelElement.prototype.updateAlign = function (align = "center") {
            var _align = {
                "top": -.5,
                "left": -.5,
                "center": 0,
        ...
        LabelElement.prototype.initStyles = function (cssClass) {
            ...
            var valRel = "translate(10000px, 10000px) ";
            stl.webkitTransform = valRel;
            stl.msTransform = valRel;
        ...
        LabelElement.prototype._renderPosition = function (position) { 
            this.updateAlign(this.posalign);
            ...
            stl.width = parseInt(position.w) * 2  + "px";
        };
        return LabelElement;
    }());
    var LabelContainer = (function () {
        ...
        LabelContainer.prototype.addOrUpdateElem = function (id, param, payload) {
            ...
            if (cur) {
                ...
                this._elements[id]["posalign"] = payload.data["position"];
            }
            else {
    ...
    function cyNodeHtmlLabel(_cy, params, options) {
        ...
        function addCyHandler(ev) {
            ...
            var param = $$find(_params.slice().reverse(), function (x) { return ((typeof target.is) == "function") ? target.is(x.query) : false; });
            if (param) {
